...
const BusinessCard = () => {
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-gradient-to-br from-green-100 via-white to-blue-100 p-4">
      <div
        className={`bg-white shadow-2xl rounded-2xl p-8 w-full max-w-md transform transition duration-500 ${
      ...
      >
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="flex justify-around items-center text-gray-600 text-base">
        ...
        <div className="flex items-center justify-between mt-6 gap-x-4">
          <button
            className="w-full py-2 bg-[#349f7b] text-white font-semibold rounded-sm hover:bg-[#2c6f60] transition duration-300"
            onClick={() => navigate("/")}
            disabled={loading}
          >
            Back to Form
